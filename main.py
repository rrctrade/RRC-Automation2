...
# VOLCHK ONLY – WS BASELINE VERSION (NO BOUNDARY HACK)
# ============================================================
...
clear_logs()
log("SYSTEM", "DEBUG ENGINE START – WS BASELINE MODE")
...
def update_candle(msg):
    ...
    # WS cumulative capture before bias
    if not BIAS_DONE:
